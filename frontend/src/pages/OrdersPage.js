  ...
  return (
    <React.Fragment>
      ...
      <Grid
        ...
        sx={{ paddingTop: 2, backgroundColor: "#F4E5C0" }}
      >
      ...
      <Grid
        ...
        alignItems="center"
        gap={2}
        sx={{ paddingTop: 5, backgroundColor: "#F4E5C0" }}
      >
        {orders !== undefined &&
          orders.map((Orderitem) => (
            <Grid item key={Orderitem._id}>
              <Card key={Orderitem._id} sx={{ height: 400, width: 900 }}>
                <CardContent>
                  <Stack direction="row" justifyContent="space-between">
                    ...
                    <div>
                      <Typography sx={{ fontSize: 14 }} color="text.primary">
                        {Orderitem.createdDate.substring(0, 10)}
                      </Typography>
                    </div>
                  </Stack>
